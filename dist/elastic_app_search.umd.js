(function(global, factory) {
    ...
    createClass(Filters, [
      {
        ...
        value: function removeFilter(filterKey) {
          ...
          function go(filterKey, filtersMap) {
            var filtered = Object.entries(filtersMap).reduce(function(
              acc,
              _ref
            ) {
              ...
              if (["all", "any", "none"].includes(filterName)) {
                ...
                filterValue = nestedFiltersArray.reduce(function(
                  acc,
                  nestedFiltersMap
                ) {
              ...
              return _extends(
                {},
                acc,
                defineProperty({}, filterName, filterValue)
              );
            },
            {});
              ...
              value.forEach(function(nestedValue) {
                Object.keys(nestedValue).forEach(function(nestedKey) {
                  if (!["all", "any", "none"].includes(nestedKey)) {
                    ...
                    acc = new Set(
                      [].concat(
                        toConsumableArray(acc),
                        toConsumableArray(
                          _this.getListOfAppliedFilters(nestedValue)
                        )
                      )
                    );
                  }
  ...
  function handleErrorResponse(_ref) {
    ...
    if (!response.ok) {
      var message = Array.isArray(json)
        ? " " +
          flatten(
            json.map(function(response) {
  ...
  var Client = (function() {
    function Client(hostIdentifier, searchKey, engineName) {
      var _ref2 =
        ...
        endpointBase =
          _ref2$endpointBase === undefined ? "" : _ref2$endpointBase,
        _ref2$cacheResponses = _ref2.cacheResponses,
        cacheResponses =
          _ref2$cacheResponses === undefined ? true : _ref2$cacheResponses,
        additionalHeaders = _ref2.additionalHeaders,
        _ref2$fetchOptions = _ref2.fetchOptions,
        fetchOptions =
          _ref2$fetchOptions === undefined ? undefined : _ref2$fetchOptions;
    ...
    createClass(Client, [
        ...
        value: function search(query) {
          ...
          var disjunctiveFacets = options.disjunctiveFacets,
            disjunctiveFacetsAnalyticsTags =
              options.disjunctiveFacetsAnalyticsTags,
            validOptions = objectWithoutProperties(options, [
              "disjunctiveFacets",
              "disjunctiveFacetsAnalyticsTags"
            ]);
      ...
      },
      {
        ...
        value: function _performDisjunctiveSearch(params, disjunctiveFacets) {
          ...
          var disjunctiveFacetsAnalyticsTags =
          ...
          var listOfAppliedDisjunctiveFilters = appliedFilers.filter(function(
            filter
          ) {
          ...
          var disjunctiveQueriesPromises = listOfAppliedDisjunctiveFilters.map(
            function(appliedDisjunctiveFilter) {
              return _this._performSearch(
                _extends({}, params, {
                  filters: filters.removeFilter(appliedDisjunctiveFilter)
                    .filtersJSON,
                  page: _extends({}, page, {
                  ...
                  analytics: analytics,
                  facets: defineProperty(
                    {},
                    appliedDisjunctiveFilter,
                    params.facets[appliedDisjunctiveFilter]
                  )
                })
              );
            }
          ...
          return Promise.all(
            [baseQueryPromise].concat(
              toConsumableArray(disjunctiveQueriesPromises)
            )
          ).then(function(_ref3) {
            ...
            disjunctiveQueries.forEach(function(disjunctiveQueryResults) {
              var _Object$entries$ = slicedToArray(
                  Object.entries(disjunctiveQueryResults.facets)[0],
                  2
                ),
